...
uint256 hashGenesisBlock("0x31285f913d43eda09992465c591707afb29d3b9c1ddf8470649e9b9fe5f73911");
...
const string strMessageMagic = "ZWD Signed Message:\n";
...
static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // ZWD: 1 days
static const int64 nTargetSpacing = 1200; // ZWD: 10 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal ZWD miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "ZWD", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Governor Gono says, GO GO";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1369875651; //epochtime
        ...
        assert(block.hashMerkleRoot == uint256("0xcaa17b9bd3b2a5986364c1e4a32699e132dc046b08fe81d3e999e54100243189"));
